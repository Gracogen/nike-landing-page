        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon) => (
              <div key={icon.src} className="w-12 h-12 flex justify-center items-center bg-white rounded-full ">
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li className="mt-3 font-montserrat leading-normal text-base text-white-400 hover:text-slate-gray cursor-pointer" key={link.name}>
                    <a>{link.name}
                    </a>
                  </li>
                ))}
                  ...
                  <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                    <div className="flex flex-1 justi  items-center gap-2 font-montserrat cursor-pointer">
