...
const [bigShoeImg, setBigShoeImg] = useState(bigShoe1)
  ...
  return (
    <section className="flex w-full xl:flex-row flex-col justify-center min-h-screen gap-16 max-container" id="home">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="font-palanquin mt-10 text-8xl mx-sm:text-[72px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative pr-10 z-1">The New Arrival</span>
          <br />
        ...
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
          {shoes.map((shoe) => (
            <div key={shoe}>
              <ShoeCard
                imgURL={shoe}
                changeBigShoeImage={(shoe) => {setBigShoeImg(shoe) }} //It works with the handleClick in the ShoeCard.
